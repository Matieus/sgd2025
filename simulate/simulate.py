...
def main():
    ...
    score = 0
    waitingForInput = (
        False  # False → pattern is playing | True → waiting for the player
    )
    ...
    while True:  # main game loop
        ...
        scoreSurf = BASICFONT.render(f"Score: {score}", 1, WHITE)
...
def changeBackgroundAnimation(animationSpeed=40):
    ...
    newBgSurf = pygame.Surface((WINDOWWIDTH, WINDOWHEIGHT)).convert_alpha()
    r, g, b = newBgColor
